    ...
    function (render, search, log, record, config) {
        function onRequest(context) {
            ...
            for (var j = 0; j < woArray.length; j++) {
                ...
                if (mapObj[itemId]) {
                    template += createTable(mapObj[itemId],salesOrderData,assemblyObjData,WOID);
                }
            }
            template += "</body>";
            template += "</pdf>";
        ...
        function createTable(level1Array,salesOrderData,assemblyObjData,WOID) {
           ...
           <tr>\
            ...
            <tr>\
             <td>\
             <table class="border" style="width: 100%"><tr>\
                 <td style="height: 40px;"><b>Special Instructions</b><br /><span>'+salesOrderData.specialIntruction+'</span></td>\
                 </tr></table>\
             </td>\
             </tr>\
           </table>';
